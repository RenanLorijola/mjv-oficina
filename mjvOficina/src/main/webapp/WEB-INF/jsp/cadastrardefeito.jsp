		        ...
		        <div class="row pb-4">
		        	<div class="col-12 mb-5">
			        	<label class="w-100 mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
							  ...
							  <input id="inputName" name="nome" class="mdc-text-field__input" type="text" aria-labelledby="my-label-id">
							  <i id="vericado" class="material-icons mdc-text-field__icon mdc-text-field__icon--trailing" tabindex="0" role="button" style="display:none">check</i>
						</label>
		        	</div>
					<a class="col-6 my-2" href="/"><button type="button" class="mdc-button" style="color:#702094">
					...
					<div class="col-1"></div>
					<button disabled id="salvar" type="submit" class="col-5 mdc-button px-3 my-2 mdc-button--raised" style="background:#BFBFBF; border-radius: 20px">
