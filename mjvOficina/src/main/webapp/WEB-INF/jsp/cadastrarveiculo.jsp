	    ...
	    <div class="modal-content">
		    <form method="post" action="/veiculo/cadastrar" >
							  ...
							  <span class="mdc-notched-outline">
							   <span class="mdc-notched-outline__leading"></span>
							    <span class="mdc-notched-outline__notch">
							      <span class="mdc-floating-label" id="my-label-id">Digite aqui o tipo de veículo</span>
							    </span>
		        	...
		        	<div class="mdc-form-field col-12 row">
		        		<div class="col-12 ml-3 pl-0" style="border-bottom: 1px black solid; background: #f0f0f0">
			        		<div class="mdc-checkbox ml-3" style="margin: 10px 0">
						  	...
						  	<label class="ml-5" style="margin-bottom: 20px; font-weight: 700; font-size: 18px">Peças</label>
			        	</div>
			        	<c:forEach items="${ pecasList }" var="peca">
				        	<div class="col-12 ml-3 pl-0" style="border-bottom: 1px black solid; background: #f0f0f0">
							    ...
							    <input type="checkbox"
								       ...
								       value="<c:out value="${ peca.nome }"></c:out>"
								       name="peca"
							   	/>
							  ...
							  <label class="ml-5" for="<c:out value="${ peca.idPeca }"></c:out>" style="margin-bottom: 30px"><c:out value="${ peca.nome }"></c:out></label>
				        	</div>
			        	</c:forEach>
		        	</div>
		        </div>
		      ...
		      <div class="modal-footer border-0 row pb-4 pr-5">
					...
					<button id="salvar" type="submit" class="mdc-button col-5 px-3 w-100 mdc-button--raised" style="background:#BFBFBF; border-radius: 20px">
